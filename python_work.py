...
# img_yatzy_sheet, img_binary_yatzy_sheet, img_binary_only_numbers, yatzy_cells_bounding_rects = sheet.generate_yatzy_sheet(input_img, num_rows_in_grid=5)
#
...
# img_binary_grid = get_yatzy_grid(img_binary_sheet)
img_generate_sheet = generate_yatzy_sheet(img)
cv2.imshow('image', img_generate_sheet)
cv2.waitKey(0)
